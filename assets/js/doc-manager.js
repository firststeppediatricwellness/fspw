const DocManager = {
    ...
    renderUI() {
        ...
        container.innerHTML = `
            <div class="doc-manager-container glass-container p-8 rounded-3xl border border-white/10 max-w-6xl mx-auto text-center relative overflow-hidden">
                ...
                <div id="dm-selection" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
                    <div class="doc-suite-card group" onclick="DocManager.showUploadAuth()">
                        <div class="suite-accent-bar bg-[#2b579a]"></div>
                        <div class="suite-icon-tile bg-[#2b579a]/10 text-[#2b579a] group-hover:bg-[#2b579a] group-hover:text-white transition-all duration-300">
                        ...
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#2b579a] transition-colors">Upload Record</h3>
                        <p class="text-slate-400 text-sm">Upload student records securely. PIN Required.</p>
                    </div>

                    <div class="doc-suite-card group" onclick="DocManager.showViewAuth()">
                        <div class="suite-accent-bar bg-[#7719aa]"></div>
                        <div class="suite-icon-tile bg-[#7719aa]/10 text-[#7719aa] group-hover:bg-[#7719aa] group-hover:text-white transition-all duration-300">
                            <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#7719aa] transition-colors">View Documents</h3>
                        <p class="text-slate-400 text-sm">Access stored records. Login Required.</p>
                    </div>

                    <div class="doc-suite-card group" onclick="DocManager.showDashboardAuth()">
                        <div class="suite-accent-bar bg-[#217346]"></div>
                        <div class="suite-icon-tile bg-[#217346]/10 text-[#217346] group-hover:bg-[#217346] group-hover:text-white transition-all duration-300">
                            <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 002 2h2a2 2 0 002-2z"></path></svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#217346] transition-colors">Analytics Dashboard</h3>
                        <p class="text-slate-400 text-sm">Visualize submission data. PIN Required.</p>
                    </div>

                    <div class="doc-suite-card group" onclick="DocManager.showWellnessAnalyser()">
                        <div class="suite-accent-bar bg-[#d24726]"></div>
                        <div class="suite-icon-tile bg-[#d24726]/10 text-[#d24726] group-hover:bg-[#d24726] group-hover:text-white transition-all duration-300">
                            <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path></svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2 group-hover:text-[#d24726] transition-colors">Wellness.ai Analyser</h3>
            ...
            <style>
                ...
                .doc-suite-card:hover .suite-accent-bar {
                    height: 8px;
                }
                .suite-icon-tile {
